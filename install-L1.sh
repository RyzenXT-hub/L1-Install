...
echo -e "\033[34mAre you performing a first-time installation or migrating L1? (Enter 1 for installation, 2 for migration)\033[0m"
echo "1) First-time installation"
echo "2) Migrate L1"
read -p "Your choice: " install_type

if [[ "$install_type" == "1" ]]; then
  echo -e "\033[33mProceeding with the first-time installation...\033[0m"
elif [[ "$install_type" == "2" ]]; then
  echo -e "\033[33mYou have chosen L1 migration.\033[0m"

  # Ask if the .titancandidate folder exists in /root/
  echo -e "\033[34mHas the .titancandidate folder already been extracted in /root/? (Y/N)\033[0m"
  read -p "Your answer: " answer

  if [[ "$answer" == "Y" || "$answer" == "y" ]]; then
    echo -e "\033[33mChecking for the existence of the .titancandidate folder...\033[0m"
    check_titan_candidate_folder
...
echo -e "\033[34mUpdating ConfigMap...\033[0m"
...
echo -e "\033[34mDownloading Titan L1 Node...\033[0m"
...
echo -e "\033[34mSetting environment variables for Titan L1...\033[0m"
export TITAN_METADATAPATH=/mnt/storage
export TITAN_ASSETSPATHS=/mnt/storage

# Create systemd service file for Titan L1
echo -e "\033[34mCreating systemd service for Titan L1...\033[0m"
...
echo -e "\033[34mEnabling Titan L1 service...\033[0m"
